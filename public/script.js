...
function sucessoPagamento() {
  ...
  shareBtnContainer.innerHTML = `
    <button onclick="window.compartilhar()" style="width:100%; padding:18px; background:#25D366; color:#fff; border-radius:50px; border:none; font-weight:bold; font-size:1.1rem; box-shadow:0 10px 25px rgba(0,0,0,0.3); display:flex; align-items:center; justify-content:center; gap:10px; cursor:pointer;">
